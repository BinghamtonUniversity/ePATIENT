      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <!-- <ul class="nav navbar-nav navbar-right visible-xs-block">
            ...
            <li><a href="/apps/epatient/admin/scenarios"><i class="fa fa-notes-medical fa-fw"></i>&nbsp; Scenarios</a></li>
            @endcan
            @can('manage_product','App\Library')
            <li><a href="/apps/epatient/admin/products" ><i class="fa fa-pills fa-fw"></i>&nbsp; Products</a></li>
            @endcan
            @can('manage_prescriber','App\Library')
            <li><a href="/apps/epatient/admin/prescribers" ><i class="fa fa-user-md fa-fw"></i>&nbsp; Providers</a></li>
            @endcan
            @can('manage_solution','App\Library')
            <li><a href="/apps/epatient/admin/solutions" ><i class="fa fa-syringe fa-fw"></i>&nbsp; Solutions</a></li>
            <li><a href="/apps/epatient/admin/additives" ><i class="fa fa-plus fa-fw"></i>&nbsp; Solution Additives</a></li>
            @endcan
            @can('manage_lab','App\Library')
            <li><a href="/apps/epatient/admin/labs" ><i class="fa fa-flask fa-fw"></i>&nbsp; Labs</a></li>
            @endcan
          </ul> -->
        </div>
      </div>
